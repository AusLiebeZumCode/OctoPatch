...
namespace OctoPatch.Descriptions
{
    ...
    public sealed class CollectorNodeDescription : NodeDescription
    {
        ...
        private CollectorNodeDescription(Guid pluginId, string key, string displayName, string displayDescription) 
        ...
        public static CollectorNodeDescription Create<T>(Guid pluginId, string displayName, string displayDescription)
        {
